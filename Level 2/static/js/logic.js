function createMap(earthquakeList) {
  ...
  // Create plate layer
  var plate_link = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
  var plateBoundary = new L.LayerGroup();

  d3.json(plate_link, function (geoJson) {
  ...
  var myMap = L.map("map-id", {
    ...
    zoom: 4,
    layers: [satellitemap, earthquakeList, plateBoundary]
  });
